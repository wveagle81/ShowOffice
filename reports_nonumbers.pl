...
#
   ...
   open (HTML_REPORT, ">temp/reportfile$$_${classnumber}.html") or die "Unable to open temp file: $!";
...
#
      ...
      open (HTML_REPORT, ">${cwd}/temp/reportfile.${index}$$.html") or die "Unable to open temp file: $!";
...
#
   ...
   @special_rider = ("J25");
   @special_num   = ("N25");
   @special_cell  = ("B25", "C25", "D25", "E25", "F25", "G25");
