...
print LOG "Total: " . scalar(@total_entries) . " - Place: $p1 - Beat: $n_beat\n";
         $n_beat   += (scalar(@total_entries) - $p2) if ($p2);
print LOG "Total: " . scalar(@total_entries) . " - Place: $p2 - Beat: $n_beat\n";
         $n_beat   += (scalar(@total_entries) - $p3) if ($p3);
print LOG "Total: " . scalar(@total_entries) . " - Place: $p3 - Beat: $n_beat\n";
         $n_beat   += (scalar(@total_entries) - $p4) if ($p4);
print LOG "Total: " . scalar(@total_entries) . " - Place: $p4 - Beat: $n_beat\n";
