...
#   $IE = Win32::OLE->new('InternetExplorer.Application') || die "Could not start Internet Explorer.Application\n";
   ...
   foreach $ii (@member_list) {
      ($regnum,$riderlastname,$riderfirstname,$rideraddress,$ridercity,$riderstate,$riderzip,$riderhomephone,$riderworkphone,$rideremail,$ridersex,$ridernumberstatus,$riderexpdate) = split(/~~/, $ii);
...
#
   ($regtype, $horsename, $horsesex, $yearfoaled, $horsecolor, $horsesire, $horsedam, $ownernum) = split(/~~/, $horse_list{$horsenum});
   ($ownername, $owneraddress, $ownercity, $ownerstate, $ownerzip, $ownerhomephone, $ownerworkphone, $owneremail, $ownersex, $owneryear, $regtype, $ownernumberstatus, $ownerexpdate) = split(/~~/, $member_list{$ownernum});

   foreach $key (sort { $a <=> $b } keys %back_entries) {
      ($backnum, $ridernum) = split(/:/, $key);
      ($ridername, $rideraddress, $ridercity, $riderstate, $riderzip, $riderhomephone, $riderworkphone, $rideremail, $ridersex, $rideryear, $regtype, $ridernumberstatus, $riderexpdate) = split(/~~/, $member_list{$ridernum});
...
#
         foreach $cle (@cl_entry) {
            ...
            ($ridername, $rideraddress, $ridercity, $riderstate, $riderzip, $riderhomephone, $riderworkphone, $rideremail, $ridersex, $rideryear, $ridertype, $ridernumberstatus, $riderexpdate) = split(/~~/, $member_list{$r});
            ($ownername, $owneraddress, $ownercity, $ownerstate, $ownerzip, $ownerhomephone, $ownerworkphone, $owneremail, $ownersex, $owneryear, $ownertype, $ownernumberstatus, $ownerexpdate) = split(/~~/, $member_list{$horseowner});
...
#
   ...
   foreach $key (sort { $a <=> $b } keys %cle) {
      ...
      ($ridername, $rideraddress, $ridercity, $riderstate, $riderzip, $riderhomephone, $riderworkphone, $rideremail, $ridersex, $rideryear, $regtype, $ridernumberstatus, $riderexpdate) = split(/~~/, $member_list{$cle{$key}});
