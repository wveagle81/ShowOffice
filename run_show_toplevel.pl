...
sub run_show_toplevel {
   ...
   if (!Exists($run_show_window)) {
      ...
      $current_entries_label .= "Current # Horses : 0";
...
#
      ...
      $rsw_frame21->Label(-anchor     => 'w',
                         ...
                         -width       =>  70,
                         -justify     => 'left',
                         -textvariable => \$horseinfolabel) -> pack(-side => 'left');
...
#
      ...
      $rsw_frame31->Label(-anchor     => 'w',
                         ...
                         -width       =>  70,
                         -justify     => 'left',
                         -textvariable => \$riderinfolabel) -> pack(-side => 'left');
...
#
#  Currently Entered Classes
#
      $rsw_frame5 = $run_show_window->
                       Frame(-background  => 'black',
                          ...
                          pack(-side   => 'top',
                               ...
                               -expand => 1,
                               -anchor => 'n');
      $rsw_frame5->Label(-text        => " Current Classes:",
                         -anchor      => 'w',
                         -background  => 'black',
                         -foreground  => 'white',
                         -borderwidth => '0',
      ...
      $rsw_frame5->Label(-anchor      => 'w',
                         ...
                         -width       =>  70,
                         -justify     => 'left',
                         -textvariable => \$backclasses) -> pack(-side => 'left');
...
#
      ...
      $rsw_frame8->Button(-text => "Change Back #", -command => \&change_back )->pack(-side => "left", -padx => 15, -pady => 5);
      $rsw_frame8->Button(-text => "Change Rider", -command => \&change_rider )->pack(-side => "left", -padx => 15, -pady => 5);
      $rsw_frame8->Button(-text => "Combine Classes", -command => \&combine_list )->pack(-side => "left", -padx => 15, -pady => 5);
      $rsw_frame8->Button(-text => "Exit", -command => sub { exit; })->pack(-side => "right", -padx => 15, -pady => 5);
...
#
      ...
      $ehw_frame12 = $enter_horse_window->
                       Frame(-background  => 'grey',
                             -borderwidth => 5,
                             -relief      => 'flat')->
                          pack(-side   => 'top',
                               ...
                               -expand => 1,
                               -anchor => 'n');
      $ehw_frame12->Label(-text       => "Expiration Date",
                         -anchor       => 'w',
                         -background   => 'grey',
                         -foreground   => 'navy',
                         -borderwidth  => '0',
                         -width        =>  20,
                         -justify      => 'left')->pack(-side => 'left');
      $ehw_frame12->Entry(-background => 'white',
                         -foreground   => 'black',
                         -takefocus    => 1,
                         -width        => 12,
                         -textvariable => \$ownerexpdate) -> pack(-side => 'left');
      ...
      $eow_frame7 = $enter_owner_window->
                       Frame(-background  => 'grey',
                          ...
                          pack(-side   => 'top',
                               ...
                               -expand => 1,
                               -anchor => 'n');
      $eow_frame7->Label(-text       => "Expiration Date",
                         -anchor       => 'w',
                         -background   => 'grey',
                         -foreground   => 'navy',
                         -borderwidth  => '0',
                         -width        =>  20,
                         -justify      => 'left')->pack(-side => 'left');
      $eow_frame7->Entry(-background => 'white',
                         -foreground   => 'black',
                         -takefocus    => 1,
                         -width        => 30,
                         -textvariable => \$ownerexpdate) -> pack(-side => 'left');
...
#
      ...
      $eow_frame8->Button(-text => "Ok",     -command => \&save_new_owner_info )->pack(-side => "left", -padx => 30, -pady => 10);
      $eow_frame8->Button(-text => "Cancel", -command => sub { $enter_owner_window->withdraw })->pack(-side => "right", -padx => 30, -pady => 10);
      ...
      $erw_frame7 = $enter_rider_window->
                       Frame(-background  => 'grey',
                          ...
                          pack(-side   => 'top',
                               ...
                               -expand => 1,
                               -anchor => 'n');
      $erw_frame7->Label(-text        => "Expiration Date",
                         -anchor      => 'w',
                         -background  => 'grey',
                         -foreground  => 'navy',
                         -borderwidth => '0',
                         -width       =>  20,
                         -justify     => 'left')->pack(-side => 'left');
      $erw_frame7->Entry(-background   => 'white',
                         -foreground   => 'black',
                         -takefocus    => 1,
                         -width        => 12,
                         -textvariable => \$riderexpdate) -> pack(-side => 'left');

#
#  Buttons
#
      $erw_frame8 = $enter_rider_window->
                       Frame(-background  => 'black',
                             -borderwidth => 5,
                             -relief      => 'flat')->
                          pack(-side   => 'top',
      ...
      $erw_frame8->Button(-text => "Ok",     -command => \&save_new_rider_info )->pack(-side => "left", -padx => 30, -pady => 10);
      $erw_frame8->Button(-text => "Cancel", -command => sub { $enter_rider_window->withdraw })->pack(-side => "right", -padx => 30, -pady => 10);
...
sub rider_list_toplevel {
   ...
   if (!Exists($rider_list_window)) {
      ...
      $rl_names_lb = $rl_names_frame->Scrolled("Listbox", -width => 80, -font => 'arial 10', -scrollbars => 'oe', -selectmode => 'single')->pack;
...
#
      ...
      $mhw_hframe18->Label(-text       => "Expiration Date",
                         -anchor       => 'w',
                         -background   => 'grey',
                         -foreground   => 'navy',
                         -borderwidth  => '0',
...
#
      ...
      $mmw_mframe12->Label(-text       => "Expiration Date",
                         -anchor       => 'w',
                         -background   => 'grey',
                         -foreground   => 'navy',
                         -borderwidth  => '0',
...
#
      ...
      $frombacknumentry = $bnw_frame1->Entry(-background   => 'white',
                         ...
                         -takefocus    => 1,
                         -width        => 6,
                         -textvariable => \$frombacknumber) -> pack(-side => 'left');
      $bnw_frame1->Label(-text         => " ",
                         ...
                         -width        =>  5,
                         -justify      => 'left')->pack(-side => 'left');
      $bnw_frame1->Label(-textvariable => \$fromhorsename,
                         -anchor       => 'w',
                         -background   => 'grey',
                         -foreground   => 'navy',
                         -borderwidth  => '0',
                         -width        =>  25,
                         -justify      => 'left')->pack(-side => 'left');
      $bnw_frame1->Label(-textvariable => \$fromridername,
                         -anchor       => 'w',
                         -background   => 'grey',
                         -foreground   => 'navy',
                         -borderwidth  => '0',
...
#
      ...
      $frombacknumentry->bind("<Return>", \&lookup_fromexisting_back_number);
      $frombacknumentry->bind("<Tab>", \&lookup_fromexisting_back_number);
      $frombacknumentry->bind("<Shift-Tab>", \&lookup_fromexisting_back_number);
...
##################################################################################
#
#  Change the Rider Number Window
#

sub change_rider_toplevel {

   if (!Exists($change_rider_window)) {
      $change_rider_window = MainWindow->new(-background  => 'black',
                                       -borderwidth => 2,
                                       -relief      => 'raised',
                                       -title       => 'Change Rider Number');

      $change_rider_window->Label(-textvariable => \$showinfo,
                              -anchor       => 'center',
                              -background   => 'navy',
                              -foreground   => 'yellow',
                              -borderwidth  => '2',
...
#
#  Existing Back Number
#
      $rnw_frame1 = $change_rider_window ->
                       Frame(-background  => 'grey',
                             -borderwidth => 5,
                             -relief      => 'flat')->
                          pack(-side   => 'top',
                               ...
                               -expand => 1,
                               -anchor => 'n');
      $rnw_frame1->Label(-text         => "Back Number",
                         -anchor       => 'w',
                         -background   => 'grey',
                         -foreground   => 'navy',
                         -borderwidth  => '0',
                         -width        =>  25,
                         -justify      => 'left')->pack(-side => 'left');
      $backnumentry = $rnw_frame1->Entry(-background   => 'white',
                         -foreground   => 'black',
                         -takefocus    => 1,
                         -width        => 6,
                         -textvariable => \$frombacknumber) -> pack(-side => 'left');
      $rnw_frame1->Label(-text         => " ",
                         -anchor       => 'w',
                         -background   => 'grey',
                         -foreground   => 'navy',
                         -borderwidth  => '0',
...
#  Class Number
#
      $rnw_frame2 = $change_rider_window ->
                       Frame(-background  => 'grey',
                             -borderwidth => 5,
                             -relief      => 'flat')->
                          pack(-side   => 'top',
                               ...
                               -expand => 1,
                               -anchor => 'n');
      $rnw_frame2->Label(-text         => "Class Number",
                         -anchor       => 'w',
                         -background   => 'grey',
                         -foreground   => 'navy',
                         -borderwidth  => '0',
                         -width        =>  25,
                         -justify      => 'left')->pack(-side => 'left');
      $classnumentry = $rnw_frame2->Entry(-background   => 'white',
                         -foreground   => 'black',
                         -takefocus    => 1,
                         -width        => 6,
                         -textvariable => \$fromclassnumber) -> pack(-side => 'left');
      $rnw_frame2->Label(-text         => " ",
                         -anchor       => 'w',
                         -background   => 'grey',
                         -foreground   => 'navy',
                         -borderwidth  => '0',
                         -width        =>  10,
                         -justify      => 'left')->pack(-side => 'left');
      $rnw_frame2->Label(-textvariable => \$fromclassname,
                         -anchor       => 'w',
                         -background   => 'grey',
                         -foreground   => 'navy',
                         -borderwidth  => '0',
...
#  From Rider Number
#
      $rnw_frame3 = $change_rider_window ->
                       Frame(-background  => 'grey',
                             -borderwidth => 5,
                             -relief      => 'flat')->
                          pack(-side   => 'top',
                               ...
                               -expand => 1,
                               -anchor => 'n');
      $rnw_frame3->Label(-text         => "From Rider Number",
                         -anchor       => 'w',
                         -background   => 'grey',
                         -foreground   => 'navy',
                         -borderwidth  => '0',
                         -width        =>  25,
                         -justify      => 'left')->pack(-side => 'left');
      $fromridernumentry = $rnw_frame3->Entry(-background   => 'white',
                         -foreground   => 'black',
                         -takefocus    => 1,
                         -width        => 10,
                         -textvariable => \$fromridernumber) -> pack(-side => 'left');
      $rnw_frame3->Label(-text         => " ",
                         -anchor       => 'w',
                         -background   => 'grey',
                         -foreground   => 'navy',
                         -borderwidth  => '0',
                         -width        =>  6,
                         -justify      => 'left')->pack(-side => 'left');
      $rnw_frame3->Label(-textvariable => \$fromridername,
                         -anchor       => 'w',
                         -background   => 'grey',
                         -foreground   => 'navy',
                         -borderwidth  => '0',
...
#  To Rider Number
#
      $rnw_frame4 = $change_rider_window ->
                       Frame(-background  => 'grey',
                             -borderwidth => 5,
                             -relief      => 'flat')->
                          pack(-side   => 'top',
                               ...
                               -expand => 1,
                               -anchor => 'n');
      $rnw_frame4->Label(-text        => "To Rider Number",
                         -anchor      => 'w',
                         -background  => 'grey',
                         -foreground  => 'navy',
                         -borderwidth => '0',
                         -width       =>  25,
                         -justify     => 'left')->pack(-side => 'left');
      $toridernumentry = $rnw_frame4->Entry(-background   => 'white',
                         -foreground   => 'black',
                         -takefocus    => 1,
                         -width        => 10,
                         -textvariable => \$toridernumber) -> pack(-side => 'left');
      $rnw_frame4->Label(-text         => " ",
                         -anchor       => 'w',
                         -background   => 'grey',
                         -foreground   => 'navy',
                         -borderwidth  => '0',
                         -width        =>  6,
                         -justify      => 'left')->pack(-side => 'left');
      $rnw_frame4->Label(-textvariable => \$toridername,
                         -anchor       => 'w',
                         -background   => 'grey',
                         -foreground   => 'navy',
                         -borderwidth  => '0',
...
#  Buttons
#
      $rnw_frame8 = $change_rider_window ->
                       Frame(-background  => 'black',
                             -borderwidth => 5,
                             -relief      => 'flat')->
                          pack(-side   => 'top',
      ...
      $rnw_frame8->Button(-text => "Ok", -command => sub { &change_rider_number(); })->pack(-side => "left", -padx => 30, -pady => 5);
      $rnw_frame8->Button(-text => "Cancel", -command => sub { $change_rider_window->withdraw(); })->pack(-side => "right", -padx => 30, -pady => 5);

      $classnumentry->bind("<Return>", \&lookup_change_entry);
      $classnumentry->bind("<Tab>", \&lookup_change_entry);
      $classnumentry->bind("<Shift-Tab>", \&lookup_change_entry);
      $fromridernumentry->bind("<Return>", \&lookup_rider_number);
      $fromridernumentry->bind("<Tab>", \&lookup_rider_number);
      $fromridernumentry->bind("<Shift-Tab>", \&lookup_rider_number);
      $toridernumentry->bind("<Return>", \&lookup_torider_number);
      $toridernumentry->bind("<Tab>", \&lookup_torider_number);
      $toridernumentry->bind("<Shift-Tab>", \&lookup_torider_number);
      ...
      $screen_width = $msgdialog->screenwidth();
      $screen_height = $msgdialog->screenheight();
      $x_pos = ($screen_width - $change_rider_window->width()) / 2;
      $y_pos = ($screen_height - $change_rider_window->height()) / 2;
      $x_pos =~ s/\..*//;
      $y_pos =~ s/\..*//;

      $change_rider_window->geometry("+$x_pos+0");
   }
}
